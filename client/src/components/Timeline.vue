<template>
    <div id="timeline-wrapper">
        <svg id="timeline-container" :height="`${(484*this.playerCount)/10}px`">
        </svg>
        <div class="legend">
            <div class="legend-entry">
                <div class="legend-symbols">
                    <img src="@/assets/auge.svg" :height="this.calcSize(1)" :width="this.calcSize(1)"/>
                    <span class="legend-fontsize">1</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/auge.svg" :height="this.calcSize(2)" :width="this.calcSize(2)"/>
                    <span class="legend-fontsize">2</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/auge.svg" :height="this.calcSize(3)" :width="this.calcSize(3)"/>
                    <span class="legend-fontsize">3</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/auge.svg" :height="this.calcSize(4)" :width="this.calcSize(4)"/>
                    <span class="legend-fontsize">4</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/auge.svg" :height="this.calcSize(5)" :width="this.calcSize(5)"/>
                    <span class="legend-fontsize">5+</span>
                </div>
                <span class="legend-fontsize">Ward(s) *gesetzt</span>
            </div>
            <div class="legend-entry">
                <div class="legend-symbols">
                    <img src="@/assets/dollar-symbol.svg" :height="this.calcSize(1)" :width="this.calcSize(1)"/>
                    <span class="legend-fontsize">1</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/dollar-symbol.svg" :height="this.calcSize(2)" :width="this.calcSize(2)"/>
                    <span class="legend-fontsize">2</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/dollar-symbol.svg" :height="this.calcSize(3)" :width="this.calcSize(3)"/>
                    <span class="legend-fontsize">3</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/dollar-symbol.svg" :height="this.calcSize(4)" :width="this.calcSize(4)"/>
                    <span class="legend-fontsize">4</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/dollar-symbol.svg" :height="this.calcSize(5)" :width="this.calcSize(5)"/>
                    <span class="legend-fontsize">5+</span>
                </div>
                <span class="legend-fontsize">Item(s) *gekauft</span>
            </div>
            <div class="legend-entry">
                <img src="@/assets/human-skull.svg" :height="this.calcSize(1)" :width="this.calcSize(1)"/>
                <span class="legend-fontsize">Spieler gestorben</span>
            </div>
            <div class="legend-entry">
                <div>
                    <img src="@/assets/monster_baron.svg" :height="this.calcSize(1.5)" :width="this.calcSize(1.5)"/>
                    <span class="legend-fontsize"> / </span>
                    <img src="@/assets/monster_drake.svg" :height="this.calcSize(1.5)" :width="this.calcSize(1.5)"/>
                </div>
                <span class="legend-fontsize">Baron Nashor / Drache getötet</span>
            </div>
        </div>
        <div class="legend">
            <div class="legend-entry">
                <div class="legend-symbols">
                    <img src="@/assets/sword.svg" :height="this.calcSize(1)" :width="this.calcSize(1)"/>
                    <span class="legend-fontsize">1</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/sword.svg" :height="this.calcSize(2)" :width="this.calcSize(2)"/>
                    <span class="legend-fontsize">2</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/sword.svg" :height="this.calcSize(3)" :width="this.calcSize(3)"/>
                    <span class="legend-fontsize">3</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/sword.svg" :height="this.calcSize(4)" :width="this.calcSize(4)"/>
                    <span class="legend-fontsize">4</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/sword.svg" :height="this.calcSize(5)" :width="this.calcSize(5)"/>
                    <span class="legend-fontsize">5</span>
                </div>
                <span class="legend-fontsize">Gegner *getötet</span>
            </div>
            <div class="legend-entry">
                <div class="legend-symbols">
                    <img src="@/assets/medieval-tower.svg" :height="this.calcSize(1)" :width="this.calcSize(1)"/>
                    <span class="legend-fontsize">1</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/medieval-tower.svg" :height="this.calcSize(2)" :width="this.calcSize(2)"/>
                    <span class="legend-fontsize">2</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/medieval-tower.svg" :height="this.calcSize(3)" :width="this.calcSize(3)"/>
                    <span class="legend-fontsize">3</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/medieval-tower.svg" :height="this.calcSize(4)" :width="this.calcSize(4)"/>
                    <span class="legend-fontsize">4</span>
                </div>
                <div class="legend-symbols">
                    <img src="@/assets/medieval-tower.svg" :height="this.calcSize(5)" :width="this.calcSize(5)"/>
                    <span class="legend-fontsize">5+</span>
                </div>
                <span class="legend-fontsize">Gebäude *zerstört</span>
            </div>
            <div class="legend-entry">
                <svg id="legend-sentiment" width="50px" height="20px" viewBox="0 0 50 20"></svg>
                <span class="legend-fontsize">Stimmung des Gesagten zum jeweiligen Zeitpunkt</span>
            </div>
        </div>
        <span id="notice">*innerhalb 30 Sekunden</span>
    </div>
</template>
...
export default {
  ...
  methods: {
        ...
        for(let y = 0; y<this.allEvents.length; y++){
            for(let i of this.$store.state.matchDataTimeline.frames){
                for(let x of i.events){
                    if(x.participantId == y+1 || x.killerId == y+1 || x.creatorId == y+1 || x.victimId == y+1){
                        this.allEvents[y].push(x)
                        if(!this.eventTypes.includes(x.type)) {this.eventTypes.push(x.type)}
                        if(this.eventGraph[y].length > 0 && this.eventGraph[y][this.eventGraph[y].length - 1][0].includes(x.type) && (x.timestamp - this.eventGraph[y][this.eventGraph[y].length - 1][2]) < 30000){
                            if(x.type == 'CHAMPION_KILL'){
                                if(x.victimId == (y+1) && this.eventGraph[y][this.eventGraph[y].length - 1][0] == 'CHAMPION_KILL_DEATH'){
                                    this.eventGraph[y][this.eventGraph[y].length - 1][1] += 1
                                    this.eventGraph[y][this.eventGraph[y].length - 1][3].push(x)
                                } else if(x.killerId == (y+1) && this.eventGraph[y][this.eventGraph[y].length - 1][0] == 'CHAMPION_KILL_KILL'){
                                    this.eventGraph[y][this.eventGraph[y].length - 1][1] += 1
                                    this.eventGraph[y][this.eventGraph[y].length - 1][3].push(x)
                                } else if(x.victimId == (y+1)){
                                    this.eventGraph[y].push([`CHAMPION_KILL_DEATH`,1,x.timestamp,[x]])
                                } else {
                                    this.eventGraph[y].push([`CHAMPION_KILL_KILL`,1,x.timestamp,[x]])
                                }
                            } else {
                                this.eventGraph[y][this.eventGraph[y].length - 1][1] += 1
                                this.eventGraph[y][this.eventGraph[y].length - 1][3].push(x)
                            ...
                            switch(x.type){
                                ...
                                case 'ELITE_MONSTER_KILL':
                                    this.eventGraph[y].push([x.type,1,x.timestamp,[x],x.monsterType])
                                    break
                                default:
                                    break
                            }
      ...
      renderChart() {
          ...
          .call(d3.axisBottom(xScale).ticks(Math.ceil((this.$store.state.matchData.gameDuration / 60.0)*6) + 1).tickFormat(function(d,i){return i>0 && i %30 === 0 ? `${d/6} min` : null}))
          .selectAll('text')
          ...
          for(let index in this.$store.state.selectedPlayer){
            ...
            if(this.$store.state.matchData.participants[index].championName.includes("'")){
                ...
                champImg = this.$store.state.matchData.participants[index].championName.charAt(0).toUpperCase() + auxName.slice(1)
            }
            playerNamesYLabelfull.push([this.$store.state.matchData.participants[index].summonerName,champImg])
            if(!this.selectedPlayers[index]) continue
            playerNamesYLabel.push([this.$store.state.matchData.participants[index].summonerName,champImg])
          }
...
-100z`
        ...
        let gradientNeg = defs.append("linearGradient")
            .attr("id",`negative`)
            .attr("x1", 0)
            .attr("x2", 0)
            .attr("y1", 0)
        ...
        let gradientPos = defs.append("linearGradient")
            .attr("id",`positive`)
            .attr("x1", 0)
            .attr("x2", 0)
            .attr("y1", "100%")
          ...
          for(let player in this.eventGraph){
            ...
            .attr("d", d3.line().x(d => xScale(d.x)).y(d => yScale(playerNamesYLabel[startingCount][0]) + yScale.bandwidth()/2  - this.calcSize(d.y)*4))
          ...
          let intervalsCount = Math.ceil((this.$store.state.matchData.gameDuration / 60.0)*6);
          ...
          .on('mousedown',function(evt) {
            if(document.getElementById('eventsTextInLens')){
            ...
            let eventGroup = lensGroup.append('g')
            .attr('y',0)
            .attr('x',0)
            ...
            let selectedEvents = eventGraph[eventGraphindex]
            .filter(x => (Math.floor(x[2] / 10000) < ((Math.floor(xScale.invert(evt.clientX - hoverDivBounds.x)) < 0 ? 0 : Math.floor(xScale.invert(evt.clientX - hoverDivBounds.x)))+selectedTimerangeCount/2)) 
            && (Math.floor(x[2] / 10000) >= ((Math.floor(xScale.invert(evt.clientX - hoverDivBounds.x)) < 0 ? 0 : Math.floor(xScale.invert(evt.clientX - hoverDivBounds.x))) - selectedTimerangeCount/2)))
            for(let event in selectedEvents){
                ...
                switch(selectedEvents[event][0]){
                    case 'CHAMPION_KILL_DEATH':
                        ...
                        .attr('height', 22)
                        .attr('width', 22)
                        .attr('href',`http://ddragon.leagueoflegends.com/cdn/${currentPatch}/img/champion/${playerNamesYLabelfull[selectedEvents[event][3][0].victimId - 1][1]}.png`)
                        ...
                        .attr('fill','white')
                        .text(`${playerNamesYLabel[Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())][0]} von `)
                        info_group.append('image')
                        .attr('id',`p${Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())}-event-${event}-img`)
                        ...
                        .attr('height', 22)
                        .attr('width', 22)
                        .attr('href',`http://ddragon.leagueoflegends.com/cdn/${currentPatch}/img/champion/${playerNamesYLabelfull[selectedEvents[event][3][0].killerId - 1][1]}.png`)
                        info_group.append('text')
                    ...
                    case 'CHAMPION_KILL_KILL':
                        ...
                        .attr('font-size',font_size_in_lens)
                        .attr('fill','white')
                        .text(`${playerNamesYLabel[Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())][0]} hat `)
                        info_group.append('image')
                        .attr('id',`p${Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())}-event-${event}-img`)
                        .attr('x',10 + document.getElementById(`p${Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())}-event-${event}`).getBoundingClientRect().width + 6 + 20)
                        .attr('y',(document.getElementsByClassName(classname_of_eventgroup).length > 1 ? parseInt(document.getElementById(`p${Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())}-event-${document.getElementsByClassName(classname_of_eventgroup).length - 2}`).attributes.y.nodeValue) + 20 : 20) - 15.5)
                    ...
                    case 'ITEM_PURCHASED':
                        ...
                        .attr('font-size',font_size_in_lens)
                        .attr('fill','white')
                        .text(`${selectedEvents[event][1] == 1 ? 'Ein' : selectedEvents[event][1] == 2 ? 'Zwei' : selectedEvents[event][1] == 3 ? 'Drei' : selectedEvents[event][1] == 4 ? 'Vier' : selectedEvents[event][1] > 4 ? 'Mehr als vier' : ''} Item${selectedEvents[event][1] == 1 ? '' : 's'} gekauft:`)
                        for(let index in selectedEvents[event][3]){
                            let image = info_group.append('image')
                            .attr('width', 22)
                            .attr('height', 22)
                            ...
                            .attr('y',(document.getElementsByClassName(classname_of_eventgroup).length > 1 ? parseInt(document.getElementById(`p${Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())}-event-${document.getElementsByClassName(classname_of_eventgroup).length - 2}`).attributes.y.nodeValue) + 20 : 20) - 15.5)
                            .attr('href',`http://ddragon.leagueoflegends.com/cdn/12.6.1/img/item/${selectedEvents[event][3][index].itemId}.png`)
                            image.append('title')
                    ...
                    case 'WARD_PLACED':
                        ...
                        .attr('font-size',font_size_in_lens)
                        .attr('fill','white')
                        .text(`${selectedEvents[event][1] == 1 ? 'Einen Ward' : selectedEvents[event][1] == 2 ? 'Zwei Wards' : selectedEvents[event][1] == 3 ? 'Drei Wards' : selectedEvents[event][1] == 4 ? 'Vier Wards' : selectedEvents[event][1] > 4 ? 'Mehr als vier Wards' : ''} platziert`)
                        break
                    case 'ELITE_MONSTER_KILL':
                        info_group.append('text')
                        .attr('id',`p${Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())}-event-${event}`)
                        ...
                        .attr('font-size',font_size_in_lens)
                        .attr('fill','white')
                        .text(`${selectedEvents[event][4] == 'BARON_NASHOR' ? 'Baron Nashor' : selectedEvents[event][3][0].monsterSubType == 'HEXTECH_DRAGON' ? 'Hextech Drache' : selectedEvents[event][3][0].monsterSubType == 'AIR_DRAGON' ? 'Luft Drache' : selectedEvents[event][3][0].monsterSubType == 'WATER_DRAGON' ? 'Wasser Drache' : 'Monster'} getötet`)
                        break
                    case 'BUILDING_KILL':
                        info_group.append('text')
                        .attr('id',`p${Math.floor((evt.clientY - hoverDivBounds.y)/ yScale.bandwidth())}-event-${event}`)
                        ...
                        .attr('font-size',font_size_in_lens)
                        .attr('fill','white')
                        .text(`${selectedEvents[event][1] == 1 ? 'Ein' : selectedEvents[event][1] == 2 ? 'Zwei' : selectedEvents[event][1] == 3 ? 'Drei' : selectedEvents[event][1] == 4 ? 'Vier' : selectedEvents[event][1] > 4 ? 'Mehr als vier' : ''} Gebäude zerstört`)
                        break
                    default:
                        info_group.append('text')
            ...
            let timestampTime = Math.floor((evt.clientX - hoverDivBounds.x) / (hoverDivBounds.width/intervalsCount));
            let textArray = voiceData[eventGraphindex]
            let auxArray = [];
            for(let i = 0; i<textArray.length;i++){
                if(!textArray[i].alternatives[0].result) continue
                for(let j = 0; j<textArray[i].alternatives[0].result.length; j++){
                    let timestampAverage = (textArray[i].alternatives[0].result[j].start + textArray[i].alternatives[0].result[j].end)/2
                    if(timestampAverage >= (timestampTime-selectedTimerangeCount/2)*10 && timestampAverage <= (timestampTime+selectedTimerangeCount/2)*10){
                        if(auxArray.length>0 && (timestampAverage - (auxArray[auxArray.length-1].start + auxArray[auxArray.length-1].end)/2) > 2){
                            let string = ''
                            for(let dashes = 0; dashes < Math.floor((timestampAverage - (auxArray[auxArray.length-1].start + auxArray[auxArray.length-1].end)/2)/2); dashes++){
                                string += '-'
                            }
            ...
            document.getElementById('timelineLensRect').attributes.height.nodeValue = Math.max(document.getElementById('eventsTextInLens').getBoundingClientRect().height + 10, 30)
            document.getElementById('timelineLensRect').attributes.transform.nodeValue = `translate( 0, ${yBandwidthMult-document.getElementById('timelineLensRect').attributes.height.nodeValue})`
            document.getElementById('eventsTextInLens').attributes.transform.nodeValue = `translate( 0, ${yBandwidthMult-document.getElementById('timelineLensRect').attributes.height.nodeValue})`
            document.getElementById('closeArea').attributes.transform.nodeValue = `translate( 0, ${yBandwidthMult-document.getElementById('timelineLensRect').attributes.height.nodeValue})`
            document.getElementById('closeX').attributes.transform.nodeValue = `translate( ${width / 3-50}, ${yBandwidthMult-document.getElementById('timelineLensRect').attributes.height.nodeValue})`
            document.getElementById('spokenWords').attributes.height.nodeValue = document.getElementById('words').getBoundingClientRect().height
            document.getElementById('spokenWords').attributes.transform.nodeValue = `translate( 0, ${yBandwidthMult - 5 - document.getElementById('timelineLensRect').attributes.height.nodeValue - document.getElementById('words').getBoundingClientRect().height})`
            document.getElementById('textArea').attributes.height.nodeValue = document.getElementById('words').getBoundingClientRect().height
            document.getElementById('textArea').attributes.transform.nodeValue = `translate( 0, ${yBandwidthMult - 5 - document.getElementById('timelineLensRect').attributes.height.nodeValue - document.getElementById('words').getBoundingClientRect().height})`
          })
          let lensGroup = container.append('g')
          ...
          .attr('fill','none')
          .attr('d',`m ${- yBandwidthFrac + width / 6} ${yBandwidthMult - 1} l ${yBandwidthFrac} ${yBandwidthFrac} l ${yBandwidthFrac} -${yBandwidthFrac} z`)
          .attr('transform', '')
          ...
          .attr('transform','')
          .on('mousedown', function(evt){
            document.getElementById('timelineLensRect').attributes.fill.nodeValue = 'none';
            // pointer-events: none; 
            // makes things clickable behind fill: none objects
            document.getElementById('timelineLensPath').attributes.fill.nodeValue = 'none';
            document.getElementById('selectedTimerange').attributes.fill.nodeValue = 'none'
            document.getElementById('closeArea').attributes.fill.nodeValue = 'none'
            document.getElementById('closeX').attributes.stroke.nodeValue = 'none'
            document.getElementById('textArea').attributes.fill.nodeValue = 'none'
          ...
          let paragraphPanel = lensGroup.append('foreignObject')
            .attr('id','spokenWords')
                        .attr('x',10)
                        .attr('y',0)
            ...
            paragraph.attr('style',`font-size: ${font_size_in_lens}; color: white; text-align: justify; display: block; padding-top:5px; padding-bottom: 5px`)
